...
def download_links_from_index():
    ...
    rootURL= "https://www.government.is/news/$LisasticSearch/Search/?SearchQuery=&ContentTypes=&Themes=&Ministries=&Year=&PageIndex=" 
    for pid in range(start_page, 23):
        ...
        for item in soup.find_all("li", {"class": "news-item-list__items__item"}):
            ...
            collected_url = 'https://www.government.is' + item.find('h2').find('a')['href']
